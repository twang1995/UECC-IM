function [scumble_front_back] = scumble_between_labels(y, front_label, back_label)
...
for i = 1 : m
    ...
    if count_front ~= 0 || count_back ~= 0
        temp = (1 - (1 / IRLbl_i_mean) * power(IRLbl_i_lambda_product, 1/(count_front + count_back)));
